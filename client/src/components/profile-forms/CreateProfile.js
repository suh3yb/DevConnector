    ...
    <Fragment>
      <Menu secondary>
        ...
        <Menu.Item position="right">
          <Button primary as={Link} icon="arrow left" to="/dashboard" content="Go Back" />
        </Menu.Item>
      </Menu>
      ...
      <Grid columns="2">
        <Grid.Column mobile="8" tablet="4" computer="4">
          <Card fluid raised>
            {!imageUrl ? (
              <Card.Content textAlign="center">No Picture Selected</Card.Content>
            ) : (
              <Image src={imageUrl} alt={profile.user.name} />
            )}
            <Card.Content extra>
              <Button primary fluid onClick={() => client.picker(options).open()}>
                Upload Image
              </Button>
            </Card.Content>
          </Card>
