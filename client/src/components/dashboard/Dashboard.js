...
import { Menu, Header, Button, Card, Divider, Icon, Responsive } from 'semantic-ui-react';
  ...
  return loading && !profile ? (
    ...
    <>
      <Menu secondary>
        ...
        <Menu.Item position="right">{profile && <DashboardActions />}</Menu.Item>
      </Menu>
      {profile ? (
            ...
            <Card.Content>
              <Menu secondary size="tiny">
                ...
                <Menu.Item position="right">
                  <Button as={Link} to="/add-experience" size="mini" basic primary circular icon>
                    <Icon name="add" />{' '}
          ...
          <Card>
            <Card.Content>
              <Menu secondary size="tiny">
                ...
                <Menu.Item position="right">
                  <Button as={Link} to="/add-education" size="mini" basic primary circular icon>
                    <Icon name="add" />{' '}
                    <Responsive as="span" minWidth={500}>
                      Add New
                    </Responsive>
